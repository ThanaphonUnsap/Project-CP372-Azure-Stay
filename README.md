...
### 1. Peak Demand ยังถูกจำกัดด้วย Non-Rack Rate
...
### 2. Non-Rack Rate คิดเป็น 61.9% ของยอดจอง — Revenue Dilution ระดับองค์กร
ปัญหาไม่ใช่แค่วันหยุดสุดสัปดาห์ แต่เป็น Structural Issue ทั้ง องค์กร ควร Review Rate Availability ในทุก Segment และตั้ง Minimum Rack Rate Contribution เป้าหมายไว้ที่ ≥50%่
